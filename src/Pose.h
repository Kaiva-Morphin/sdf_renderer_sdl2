...
Pose compute_pose(RawPose pose){ // replace NAN -> 0 and compute rotmats
    Pose out;
    out.head = {
        ...
        vec4((isnan(pose.head_pos.x)?0:pose.head_pos.x), (isnan(pose.head_pos.y)?0:pose.head_pos.y), (isnan(pose.head_pos.z)?0:pose.head_pos.z), 0) * 0.0f
    };
    out.torso = {
        ...
        vec4((isnan(pose.torso_pos.x)?0:pose.torso_pos.x), (isnan(pose.torso_pos.y)?0:pose.torso_pos.y), (isnan(pose.torso_pos.z)?0:pose.torso_pos.z), 0) * 1.0f
    };
    out.left_arm = {
        ...
        vec4((isnan(pose.left_arm_pos.x)?0:pose.left_arm_pos.x), (isnan(pose.left_arm_pos.y)?0:pose.left_arm_pos.y), (isnan(pose.left_arm_pos.z)?0:pose.left_arm_pos.z), 0) * 0.0f
    };
    out.right_arm = {
        ...
        vec4((isnan(pose.right_arm_pos.x)?0:pose.right_arm_pos.x), (isnan(pose.right_arm_pos.y)?0:pose.right_arm_pos.y), (isnan(pose.right_arm_pos.z)?0:pose.right_arm_pos.z), 0) * 0.0f
    };
    out.left_leg = {
        ...
        vec4((isnan(pose.left_leg_pos.x)?0:pose.left_leg_pos.x), (isnan(pose.left_leg_pos.y)?0:pose.left_leg_pos.y), (isnan(pose.left_leg_pos.z)?0:pose.left_leg_pos.z), 0) * 0.0f
    };
    out.right_leg = {
        ...
        vec4((isnan(pose.right_leg_pos.x)?0:pose.right_leg_pos.x), (isnan(pose.right_leg_pos.y)?0:pose.right_leg_pos.y), (isnan(pose.right_leg_pos.z)?0:pose.right_leg_pos.z), 0) * 0.0f
    };
